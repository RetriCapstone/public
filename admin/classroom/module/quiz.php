...
<head>
    ...
    <link rel="stylesheet" href="/admin/classroom/module/style/quiz.css">
            ...
            <div class="con-1">
                ...
                <div class="quiz-containers quiz-questions-container">
                    ...
                    <div class="style-container-1 quiz-direction-container">
                        <textarea rows="2" required autocomplete="off" class="quiz-direction-input auto-height-text-dir"
                            placeholder="Direction/Description"></textarea>
                    </div>
                    ...
                    <div class="style-container-1 settings-container">
                        ...
                        <div class="settings-card-col">
                            ...
                            <input class="quiz-identify-answer settings-quiz-name-input" id="quiz-settings-name-input"
                                type="text" required autocomplete="off" placeholder="Quiz name">
                        </div>
