            ...
            <div class="main_container">
                ...
                <div class="con-1">
                    <div class="style-header">
                        <h2>Classroom</h2>
                        <button id="btn-create-classroom" class="style-btn-create-1"><i
                                class="fa-solid fa-plus"></i>Create Class</button>
                            ...
                            <div class="create-classroom-modal">
                                ...
                                <form action="" id="create-class-form" class="form-create-class">
                                    <div class="style-divider">
                                        ...
                                        <input type="text" style="text-transform:uppercase" id="classname"
                                            class="input-style input-create-class" placeholder="Class name" required
                                            autocomplete="off">
                                        <p class="hint-style">&nbsp;<i
                                                class="fa-solid fa-circle-exclamation icon-style"></i> RECOMMEND:
                                            SUBJECT NAME - SECTION</p>
                                    </div>

                                    <div class="style-divider">
                                        <label>&nbsp;Classroom code:</label>
                                        <input type="text" id="classcode" class="input-style input-create-class"
                                            placeholder="Class code" required autocomplete="off">
                                        <p class="hint-style">&nbsp;<i
                                                class="fa-solid fa-circle-exclamation icon-style"></i> RECOMMEND:
                                            SUBJECT - RANDOM NUMBER</p>
                                    </div>
