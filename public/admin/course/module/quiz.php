                ...
                <div class="con-1">
                    ...
                    <div class="quiz-containers quiz-questions-container">
                        ...
                        <div class="style-container-1 quiz-direction-container">
                            <textarea rows="2" required autocomplete="off"
                                class="quiz-direction-input auto-height-text-dir" placeholder="Instruction"></textarea>
                        </div>
                            ...
                            <div class="style-modal-content-quiz edit-module-modal">
                                ...
                                <div class="quiz-answer-content">
                                    ...
                                    <div class="quiz-answer-footer">
                                        <button id="btn-save-score-details" class="style-btn-add-1">Save
                                            changes</button>
                                    </div>
                                </div>
                    ...
                    <div class="quiz-containers quiz-settings-container">
                        <div class="style-container-1 settings-container">
                            ...
                            <div class="settings-card-col">
                                ...
                                <input class="quiz-identify-answer settings-quiz-name-input"
                                    id="quiz-settings-name-input" type="text" required autocomplete="off"
                            ...
                            <div class="settings-card-col">
                                ...
                                <div class="settings-datetime-con">
                                    <div>
                                        ...
                                        <input class="settings-datetime" type="datetime-local"
                                            name="quiz-datetime-start" id="">
                                        <p class="settings-label-body">
