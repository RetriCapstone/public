...
function addCodeQuestion() {
    ...
    <div class="code-question-body">
        <div class="code-body-card-1">
            <div class="code-tool-con" style="display:none;" >
            ...
            <div class="code-text-list-container" id="code-desc-list-question-${questionNumber}">
                <div class="code-desc-con question-title" id="code-title-desc-question-${questionNumber}-item-${itemNumber}">
                    <div class="text-desc-body">
                        <textarea class="code-text-field text-question" readonly autocomplete="off" required placeholder="Question title" id="title-desc-input-question-${questionNumber}"></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="code-body-card-2">
            <div class="code-editor-con">
                <div class="code-editor-header compiler-header">
                    ...
                    <button style="display:none;" class="btn-code-submit" id="btn-submit-question-${questionNumber}">
                ...
                <div class="editor-container compiler-editor" id="code-compiler-ide-question-${questionNumber}">
                    ...
                    <textarea readonly id="codeEditor-question-${questionNumber}" class="code-editor" spellcheck="false" placeholder="<code>"></textarea>
                </div>

                <div class="editor-container input-editor" id="code-input-ide-question-${questionNumber}" style="display: none;">
                    <div class="line-numbers" id="lineNumbers"></div>
                    <textarea readonly id="codeInput-question-${questionNumber}" class="code-editor" spellcheck="false" placeholder="<input>"></textarea>
                </div>

                <div class="code-output-con output-editor" id="code-output-ide-question-${questionNumber}" style="display: none;">
                    <textarea readonly id="codeOutput-question-${questionNumber}" class="code-output-editor" spellcheck="false" placeholder="<output>"></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="code-question-bottom">
        ...
        <div class="question-point-container" >
            <input readonly type="number" value="1" id="code-point-input-question-${questionNumber}">
            <span>points</span>
        </div>

        <div style="display:none;" class="delete-question-con" id="code-delete-button-question-${questionNumber}">
...
async function fetchCodingQuestion() {
    ...
    try {
        ...
        const sectionDocRef = doc(db, 'course', classroomCourse, 'module', selectedModuleId, 'activity', selectedActivityId);
        const questionsCollectionRef = collection(sectionDocRef, 'question');
...
async function fetchQuizDetails() {
    try {
        ...
        const quizDocRef = doc(db, 'course', classroomCourse, 'module', selectedModuleId, 'activity', selectedActivityId);
        const quizDoc = await getDoc(quizDocRef);

        const classquizDocRef = doc(db, 'teacher', teacherId, 'classroom', selectedClassroomId, 'module', selectedModuleId, 'activity', selectedActivityId);
