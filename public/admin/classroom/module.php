                ...
                <div class="con-1">
                        ...
                        <div class="style-modal-content create-module-modal">
                            ...
                            <form action="" id="create-module-form" class="form-create-module">
                                <div class="style-divider">
                                    ...
                                    <input type="text" id="module-name" class="input-style input-create-class"
                                        placeholder="Module name" required autocomplete="off"
                                        style="text-transform: uppercase;">
                                </div>
                                <div class="style-divider2">
                                    <input class="module-pos-option" type="radio" id="end" value="end" name="position"
                                        checked>
                                    <label for="end" class="radio-label">At the End</label>

                                    <input class="module-pos-option" type="radio" id="begin" value="begin"
                                        name="position">
                                    <label for="begin" class="radio-label">At the Beginning</label>

                                    <input class="module-pos-option" type="radio" id="after" value="after"
                                        name="position">
                    ...
                    <div id="modal-create-module-item" class="style-modal">
                        ...
                        <div class="style-modal-content create-module-item-modal">
                            ...
                            <h2>Module item</h2>
                            <hr class="divider-solid">
                            <form action="" id="create-module-item-form"
                                class="form-create-module form-create-module-item">
                                <div class="style-divider">
                                    <label class="style-label-modal">&nbsp;Item Name:</label>
                                    <input type="text" style="text-transform: uppercase;" id="module-item-name"
                                        class="input-style input-create-class" placeholder="Input Name" required
                                        autocomplete="off">
                                </div>
                                <div class="style-divider2">
                                ...
                                <div class="create-class-btn">
                                    <input type="button" value="Cancel" class="style-btn-del"
                                        id="cancel-module-item-modal">
                                    <input type="submit" value="Create" class="style-btn-add-1">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="style-modal-content edit-module-modal">
                            ...
                            <form action="" id="edit-module-form" class="form-create-module form-create-module-item">
                                <div class="style-divider">
                                    ...
                                    <input type="text" style="text-transform: uppercase;" id="selected-module-name"
                                        class="input-style input-create-class" placeholder="Input Name" required
                                        autocomplete="off">
                                </div>
                                <div class="edit-module-btn">
                                    <div>
                                        <input type="button" value="Delete Module" class="style-btn-del"
                                            id="delete-module">
                                    </div>
                                    <div style="display: flex; gap: .8rem;">
                                        <input type="button" value="Cancel" class="style-btn-del"
                                            id="cancel-edit-module-modal">
                        ...
                        <div class="style-modal-content edit-classroom-modal">
                            ...
                            <form action="" id="edit-classroom-form" class="form-create-module ">
                                ...
                                <div class="style-divider">
                                    ...
                                    <input type="text" style="text-transform:uppercase" id="edit-classroom-name"
                                        class="input-style input-create-class" placeholder="Class name" required
                                        autocomplete="off">
                                    <p class="hint-style">&nbsp;<i
                                            class="fa-solid fa-circle-exclamation icon-style"></i> RECOMMEND: SUBJECT
                                        NAME - SECTION</p>
                                </div>

                                <div class="style-divider">
                                    <label>&nbsp;Classroom code:</label>
                                    <input type="text" id="edit-classroom-code" class="input-style input-create-class"
                                        placeholder="Class code" required autocomplete="off">
                                    <p class="hint-style">&nbsp;<i
                                            class="fa-solid fa-circle-exclamation icon-style"></i> RECOMMEND: SUBJECT -
                                        RANDOM NUMBER</p>
                                </div>
                                ...
                                <div class="edit-module-btn">
                                    <div>
                                        <input type="button" value="Delete classroom" class="style-btn-del"
                                            id="delete-classroom">
                                    </div>
                                    <div style="display: flex; gap: .8rem;">
                                        <input type="button" value="Cancel" class="style-btn-del"
                                            id="cancel-edit-class-modal">
                                        <input type="submit" value="Save" class="style-btn-add-1">
                                    </div>
                                </div>
                            </form>
