...
<body>
    ...
    <script type="module" src="script/course-quiz.js"></script>
    ...
    <div class="container">
        ...
        <div class="quiz-tool-container"  style="display: none;" >
        </div>
        <div class="main_body" style="max-width: none;" >
            ...
            <div class="con-1" style="width: 80%; max-width: 1100px;" >
                ...
                <div style="width: 100%; max-width: 1100px; text-align: center; padding: .2rem; background: #223478;">
                    <p>Only the admin can edit the content of this quiz</p>
                </div>
                <div class="quiz-containers quiz-questions-container" style="padding: 0;" >

                    <!-- Quiz container of dirction/Description -->
                    <div class="style-container-1 quiz-direction-container">
                        <textarea rows="2" readonly required autocomplete="off" class="quiz-direction-input auto-height-text-dir"
                            placeholder="Instruction"></textarea>
                    </div>

                </div>
                <!-- Responses view container -->
                <div class="quiz-containers quiz-responses-container"  style="padding: 0;" >
                ...
                <div class="quiz-containers quiz-settings-container"  style="padding: 0;" >
                    <div class="style-container-1 settings-container">
                        ...
                        <div class="settings-card-col">
                            ...
                            <input class="quiz-identify-answer settings-quiz-name-input" id="quiz-settings-name-input"
                                type="text" readonly required autocomplete="off" placeholder="Quiz name">
                        </div>
                        ...
                        <div class="settings-card-col">
                            ...
                            <div class="settings-datetime-con">
                                <div>
                                    ...
                                    <input class="settings-datetime" type="datetime-local" name="quiz-datetime-start"
                                        id="">
                                    <p class="settings-label-body">
                                ...
                                <div>
                                    <span>Due date:</span>
                                    <input class="settings-datetime" type="datetime-local" name="quiz-datetime-end"
                                        id="">
                                    <p class="settings-label-body">
                        ...
                        <div class="settings-card-bottom">
                            <button style="display: none;" class="style-btn-del" id="btn-delete-quiz">Delete quiz</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="quiz-tool-container quiz-item-container" style="display: none;" >
