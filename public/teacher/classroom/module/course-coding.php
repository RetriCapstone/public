    ...
    <div class="container">
        ...
        <div class="main_body">
            ...
            <div class="code-header-con">
                <div style="display: none;"  class="code-question-add" id="code-add-question">
                ...
                <div class="code-settings-con">
                    ...
                    <div class="style-container-1 settings-container">
                        ...
                        <div class="settings-card-col">
                            ...
                            <input readonly class="quiz-identify-answer settings-quiz-name-input" id="quiz-settings-name-input"
                                type="text" required autocomplete="off" placeholder="activity name">
                        </div>
